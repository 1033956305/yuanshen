<template>
  <div class="login">
    <div class="login-form">
      ...
      <form>
        <input type="text" class="text" v-model="userName" value="Username" placeholder="请输入用户名">
        <div class="key">
          <input type="password" value="Password" v-model="userPWD" placeholder="请输入密码">
          <i></i>
...
export default {
  ...
  methods: {
    submit: function () {
      var that = this
      console.log(APP_CONSTANT.LOGINURL)
      $.ajax({
        url: APP_CONSTANT.LOGINURL,
        type: 'POST',
        dataType: 'json',
        contentType: 'application/json',
        data: '{"username": "' + that.userName + '", "userpwd": "' + that.userPWD + '" }',
        success: function (result) {
          console.log(result)
          if (result.loginflag) {
            localStorage.setItem('YASUserCompanyId', result.companyid)
            localStorage.setItem('YASUserName', that.userName)
