      ...
      <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html"><strong>欢迎</strong></a>
          ...
          <ul class="nav navbar-top-links navbar-right">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu dropdown-user">
                <li><a href="#"><i class="fa fa-user fa-fw"></i> 用户信息(暂未开放)</a>
                </li>
                <li><a href="#"><i class="fa fa-gear fa-fw"></i> 设置(暂未开放)</a>
                </li>
                <li class="divider"></li>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
          <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
              <li v-on:click="menuClick($event)" class="active-menu detail">
                <router-link to="/detail"><i class="fa fa-dashboard"></i> 查看信息</router-link>
              </li>
              <li v-on:click="menuClick($event)" class="download">
                <router-link to="/detail/download"><i class="fa fa-desktop"></i> 下载信息</router-link>
              </li>
              <li v-on:click="menuClick($event)" class="search">
                <router-link to="/detail/search"><i class="fa fa-desktop"></i> 信息查询</router-link>
              </li>
            </ul>
...
export default {
    ...
    if (companyId && userName) {
      ...
      if (hash.split('#').length > 1) {
        if (hash.split('#')[1] === '/detail') {
          ...
          $('#main-menu>li.detail').addClass('active-menu')
        } else if (hash.split('#')[1] === '/detail/download') {
          $('#main-menu>li').removeClass('active-menu')
          $('#main-menu>li.download').addClass('active-menu')
        } else if (hash.split('#')[1] === '/detail/search') {
          $('#main-menu>li').removeClass('active-menu')
          $('#main-menu>li.search').addClass('active-menu')
        }
      }
    } else {
  ...
  methods: {
    ...
    loginOutSure: function () {
      $('#myModal').modal('hide')
      localStorage.removeItem('YASUserCompanyId')
      localStorage.removeItem('YASUserName')
      this.$router.push({path: '/login'})
    }
  }
}
